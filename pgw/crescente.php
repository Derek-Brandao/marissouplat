...
$result = $conexao -> query("SELECT nome, preco, estoque FROM produto order by preco asc");

if($result){
	echo '<big><big><big><table border="1" style="color: white;border: white 3px solid; position: relative; bottom: 110px"><tr><td>' . 'Produto' . '</td><td>' . 'Preco' . '</td><td>' . 'Estoque' . '</td></tr><br/></big></big></big>';
